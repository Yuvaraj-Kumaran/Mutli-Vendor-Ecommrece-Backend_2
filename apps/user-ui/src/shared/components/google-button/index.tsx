...
const GoogleButton = () => {
  return (
    <div className="w-full flex justify-center">
      <div className="h-[46px] cursor-pointer border border-blue-100 flex items-center gap-2 px-3 rounded-[4px] my-2 bg-gray-200">
        <svg
          id="Icons"
        ...
        <span className="text-[16px] opacity-[.8] font-Poppins leading-none">
            Sign In With Google
        </span>
      </div>
    </div>
