  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <label className="block text-gary-700 mb-1">Name *</label>
        <input
          type="text"
        ...
        <label className="block text-gary-700 mb-1">
          Bio (Max 100 words) *
        </label>
        <input
          type="text"
        ...
        <label className="block text-gary-700 mb-1">Address *</label>
        <input
          type="text"
        ...
        <label className="block text-gary-700 mb-1">Opening Hours *</label>
        <input
          type="text"
        ...
        <label className="block text-gary-700 mb-1">Website</label>
        <input
          type="url"
        ...
        <label className="block text-gary-700 mb-1">Category *</label>
        <select
          className="w-full p-2 border border-gray-300 outline-0 rounded-[4px] mb-1"
          {...register("category", {
